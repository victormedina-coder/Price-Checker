  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', height: 28, width: 172, flexShrink: 0 }}>
          <Image src={logoNegro} alt="Stetson" fill sizes="172px" priority style={{ objectFit: 'cover', objectPosition: 'center' }} />
        </div>
