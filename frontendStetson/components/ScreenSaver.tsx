...
import lifestyleImg from "../assets/images/26_Stetson_SS26_Western__DSC7595_R.jpg";
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(30,10,10,0.80) 0%, rgba(30,10,10,0.60) 100%)',
      }}/>
      ...
      {[0, 1, 2].map(i => (
        <div key={i} style={{
          ...
          borderRadius: '50%',
          border: `1.5px solid rgba(241,238,234,0.25)`,
      ...
      <div style={{
        ...
        <div style={{
          ...
          textShadow: `0 0 60px rgba(63,30,31,0.9)`,
        }}>
      ...
      <div style={{
        ...
        backgroundImage: `
          linear-gradient(rgba(63,30,31,0.07) 1px, transparent 1px),
          linear-gradient(90deg, rgba(63,30,31,0.07) 1px, transparent 1px)
        `,
