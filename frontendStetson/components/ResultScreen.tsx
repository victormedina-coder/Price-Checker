...
function BranchRow({ branch, isCurrentStore }: { branch: Stock; isCurrentStore: boolean }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: 10,
      border: `1.5px solid ${isCurrentStore ? 'rgba(63,30,31,0.4)' : 'var(--border)'}`,
    }}>
    ...
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 3 }}>
          <div style={{ position: 'relative', height: 26, width: 160, flexShrink: 0 }}>
            <Image src={logoNegro} alt="Stetson" fill sizes="160px" style={{ objectFit: 'cover', objectPosition: 'center' }} />
          </div>
      ...
      <div className="result-layout" style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 0 }}>
        ...
        <div style={{
          ...
          <div className="slide-up slide-up-d1" style={{
            ...
            border: hasSale ? `2px solid rgba(63,30,31,0.22)` : `1.5px solid var(--border)`,
          }}>
            {hasSale && (
