...
import lifestyleImg from "../assets/images/WB LIFESTYLE.png";
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, rgba(26,10,14,0.78) 0%, rgba(26,10,14,0.58) 100%)',
      }}/>
      ...
      {[0, 1, 2].map(i => (
        <div key={i} style={{
          ...
          borderRadius: '50%',
          border: `1.5px solid rgba(246,254,162,0.25)`,
      ...
      <div style={{
        ...
        {/* Logo */}
        <div style={{ position: 'relative', height: 30, width: 471, flexShrink: 0, opacity: 0.92, marginBottom: 4 }}>
          <Image src={logoBlanco} alt="Western Brothers" fill sizes="471px" style={{ objectFit: 'cover', objectPosition: 'center' }} />
        </div>
        ...
        <div style={{
          ...
          textShadow: `0 0 60px rgba(104,62,73,0.8)`,
        }}>
      ...
      <div style={{
        ...
        backgroundImage: `
          linear-gradient(rgba(104,62,73,0.07) 1px, transparent 1px),
          linear-gradient(90deg, rgba(104,62,73,0.07) 1px, transparent 1px)
        `,
