...
export default function MaintenanceScreen() {
  return (
    <div style={{
      ...
      {/* Logo */}
      <div style={{ position: 'relative', height: 28, width: 172, flexShrink: 0, marginBottom: 40, opacity: 0.6 }}>
        <Image src={logoNegro} alt="Stetson" fill sizes="172px" style={{ objectFit: 'cover', objectPosition: 'center' }} />
      </div>
